    ...
    public class EmployeeInitializer : DropCreateDatabaseAlways<EmployeeContext>
    {
        protected override void Seed(EmployeeContext context)
        {
            var employees = new List<Employee>
            {
                ...
                new Employee {EmployeeID = 5, FirstName = "Angitha", LastName = "Das", Title = "Ms.",BirthDate = Convert.ToDateTime("1-1-1993 12:00:00 AM") ,HireDate = Convert.ToDateTime("7-18-2016 12:00:00 AM"),Address = "This", City = "Is", Region = "My", PostalCode = "658965", Country = "IN", HomePhone = "8586258565" },
